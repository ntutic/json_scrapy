.. currentmodule:: jscrapy.extensions.telnet
...
By default Username is ``jscrapy`` and Password is autogenerated. The
autogenerated Password can be seen on Scrapy logs like the example below::

    2018-10-16 14:35:21 [jscrapy.extensions.telnet] INFO: Telnet Password: 16f92501e8a59326
...
+================+===================================================================+
| ``crawler``    | the Scrapy Crawler (:class:`jscrapy.crawler.Crawler` object)       |
+----------------+-------------------------------------------------------------------+
