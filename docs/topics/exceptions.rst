...
Raised from a :class:`~jscrapy.signals.bytes_received` or :class:`~jscrapy.signals.headers_received`
...
See the documentation for the :class:`~jscrapy.signals.bytes_received` and
:class:`~jscrapy.signals.headers_received` signals
