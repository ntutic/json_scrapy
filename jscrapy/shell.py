...
from jscrapy.utils.conf import get_config
from jscrapy.utils.console import DEFAULT_PYTHON_SHELLS, start_python_console
from jscrapy.utils.datatypes import SequenceExclude
...
class Shell:
    ...
    def start(self, url=None, request=None, response=None, spider=None, redirect=True):
        ...
        if self.code:
            ...
            """
            Detect interactive shell setting in jscrapy.cfg
            e.g.: ~/.config/jscrapy.cfg or ~/.jscrapy.cfg
            [settings]
    ...
    def get_help(self):
        ...
        b.append("  jscrapy     jscrapy module (contains jscrapy.Request, jscrapy.Selector, etc)")
        ...
        if self.inthread:
            ...
            b.append("  fetch(req)                  "
                     "Fetch a jscrapy.Request and update local objects ")
