...
from jjscrapy.shell import Shell
from jjscrapy.utils.spider import spidercls_for_request, DefaultSpider
from jjscrapy.utils.url import guess_scheme
...
class Command(ScrapyCommand):
    ...
    default_settings = {
        'KEEP_ALIVE': True,
        'LOGSTATS_INTERVAL': 0,
        'DUPEFILTER_CLASS': 'jjscrapy.dupefilters.BaseDupeFilter',
    }
    ...
    def update_vars(self, vars):
        """You can use this function to update the JON Scrapy objects that will be
