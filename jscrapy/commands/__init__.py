...
from jjscrapy.utils.conf import arglist_to_dict, feed_process_params_from_cli
...
class ScrapyCommand:
    ...
    def __init__(self):
        self.settings = None  # set in jscrapy.cmdline
...
class ScrapyHelpFormatter(argparse.HelpFormatter):
    """
    Help Formatter for jscrapy command line help messages.
    """
