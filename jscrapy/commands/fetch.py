...
from jjscrapy.http import Request
from jjscrapy.exceptions import UsageError
from jjscrapy.utils.datatypes import SequenceExclude
from jjscrapy.utils.spider import spidercls_for_request, DefaultSpider
...
class Command(ScrapyCommand):
    ...
    def short_desc(self):
        return "Fetch a URL using the JSON downloader"

    def long_desc(self):
        return (
            "Fetch a URL using the JSON Scrapy downloader and print its content"
