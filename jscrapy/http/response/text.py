...
from jscrapy.utils.python import memoizemethod_noargs, to_unicode
from jscrapy.utils.response import get_base_url
...
class TextResponse(Response):
    ...
    def follow(self, url, callback=None, method='GET', headers=None, body=None,
        ...
        * a relative URL
        * a :class:`~jscrapy.link.Link` object, e.g. the result of
          :ref:`topics-link-extractors`
        * a :class:`~jscrapy.selector.Selector` object for a ``<link>`` or ``<a>`` element, e.g.
          ``response.css('a.my_link')[0]``
        * an attribute :class:`~jscrapy.selector.Selector` (not SelectorList), e.g.
