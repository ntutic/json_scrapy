...
import jscrapy
from jscrapy.http.common import obsolete_setter
...
from jscrapy.utils.trackref import object_ref
from jscrapy.utils.url import escape_ajax
...
class Request(object_ref):
    ...
    :func:`~jscrapy.utils.request.request_from_dict`.
    """
    ...
    def from_curl(
        ...
        .. caution:: Using :meth:`from_curl` from :class:`~jscrapy.http.Request`
                     subclasses, such as :class:`~jscrapy.http.JSONRequest`, or
                     :class:`~jscrapy.http.XmlRpcRequest`, as well as having
                     :ref:`downloader middlewares <topics-downloader-middleware>`
                     and
                     :ref:`spider middlewares <topics-spider-middleware>`
                     enabled, such as
                     :class:`~jscrapy.downloadermiddlewares.defaultheaders.DefaultHeadersMiddleware`,
                     :class:`~jscrapy.downloadermiddlewares.useragent.UserAgentMiddleware`,
                     or
                     :class:`~jscrapy.downloadermiddlewares.httpcompression.HttpCompressionMiddleware`,
                     may modify the :class:`~jscrapy.http.Request` object.
    ...
    def to_dict(self, *, spider: Optional["jscrapy.Spider"] = None) -> dict:
        """Return a dictionary containing the Request's data.

        Use :func:`~jscrapy.utils.request.request_from_dict` to convert back into a :class:`~jscrapy.Request` object.
