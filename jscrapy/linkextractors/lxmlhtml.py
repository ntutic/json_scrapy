...
from jscrapy.utils.misc import arg_to_iter, rel_has_nofollow
from jscrapy.utils.python import unique as unique_list
...
class LxmlLinkExtractor(FilteringLinkExtractor):
    ...
    def extract_links(self, response):
        """Returns a list of :class:`~jscrapy.link.Link` objects from the
        specified :class:`response <jscrapy.http.Response>`.
