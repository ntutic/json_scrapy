...
class FilteringLinkExtractor:
    ...
    def __new__(cls, *args, **kwargs):
        ...
        if issubclass(cls, FilteringLinkExtractor) and not issubclass(cls, LxmlLinkExtractor):
            warn('jscrapy.linkextractors.FilteringLinkExtractor is deprecated, '
                 'please use jscrapy.linkextractors.LinkExtractor instead',
...
# Top-level imports
from jscrapy.linkextractors.lxmlhtml import LxmlLinkExtractor as LinkExtractor
