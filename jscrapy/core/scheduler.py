...
class BaseScheduler(metaclass=BaseSchedulerMeta):
    ...
    * Downloader middleware: ``process_request``, ``process_response`` and ``process_exception`` methods
    ...
    def from_crawler(cls, crawler: Crawler):
        """
        Factory method which receives the current :class:`~jscrapy.crawler.Crawler` object as argument.
        """
        return cls()
    ...
    def open(self, spider: Spider) -> Optional[Deferred]:
        ...
        :type spider: :class:`~jscrapy.spiders.Spider`
        """
        pass
    ...
    def next_request(self) -> Optional[Request]:
        """
        Return the next :class:`~jscrapy.http.Request` to be processed, or ``None``
...
class Scheduler(BaseScheduler):
    ...
    :type dupefilter: :class:`jscrapy.dupefilters.BaseDupeFilter` instance or similar:
    ...
    :type stats: :class:`jscrapy.statscollectors.StatsCollector` instance or similar:
    ...
    :type crawler: :class:`jscrapy.crawler.Crawler`
    """
    def __init__(
        self,
        dupefilter,
    ...
    def next_request(self) -> Optional[Request]:
        """
        Return a :class:`~jscrapy.http.Request` object from the memory queue,
