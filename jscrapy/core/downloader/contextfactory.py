...
from jscrapy.core.downloader.tls import DEFAULT_CIPHERS, openssl_methods, ScrapyClientTLSOptions
...
class ScrapyClientContextFactory(BrowserLikePolicyForHTTPS):
    ...
    def getCertificateOptions(self):
        ...
        #   (https://github.com/jscrapy/jscrapy/issues/1429#issuecomment-131782133)
        #
