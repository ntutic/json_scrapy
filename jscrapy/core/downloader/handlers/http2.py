...
from jscrapy.core.http2.agent import H2Agent, H2ConnectionPool, ScrapyProxyH2Agent
        ...
        if proxy:
            ...
            if omit_connect_tunnel:
                warnings.warn(
                    ...
                    "anymore, so you should update jscrapy-crawlera to "
                    "jscrapy-zyte-smartproxy and remove '?noconnect' from the "
