"""
An asynchronous FTP file download handler for jscrapy which somehow emulates an http response.
...
- ftp_local_filename
        - If not given, file data will come in the response.body, as a normal jscrapy Response,
