...
from jscrapy.core.downloader.contextfactory import load_context_factory_from_settings
from jscrapy.core.downloader.webclient import _parse
from jscrapy.exceptions import ScrapyDeprecationWarning, StopDownload
...
class TunnelingTCP4ClientEndpoint(TCP4ClientEndpoint):
    ...
    def processProxyResponse(self, rcvd_bytes):
        ...
        #
        # see https://github.com/jscrapy/jscrapy/issues/2491
...
def tunnel_request_data(host, port, proxy_auth_header=None):
    ...
    >>> from jscrapy.utils.python import to_unicode as s
        ...
        if proxy:
            ...
            if omitConnectTunnel:
                warnings.warn(
                    ...
                    "this mode anymore, so you should update jscrapy-crawlera "
                    "to jscrapy-zyte-smartproxy and remove '?noconnect' "
