...
def request_fingerprint(
    ...
    if include_headers or keep_fragments:
        message = (
            ...
            'jscrapy.utils.request.request_fingerprint().\n'
            '\n'
            ...
            'jscrapy.utils.request.fingerprint() function instead.\n'
            '\n'
...
class RequestFingerprinter:
    ...
    <jscrapy.http.Request.url>` and the values of :attr:`request.method
    <jscrapy.http.Request.method>` and :attr:`request.body
    <jscrapy.http.Request.body>`. It then generates an `SHA1
...
def request_from_dict(d: dict, *, spider: Optional[Spider] = None) -> Request:
    """Create a :class:`~jscrapy.Request` object from a dict.
