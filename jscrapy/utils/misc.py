...
from jscrapy.utils.datatypes import LocalWeakReferencedCache
from jscrapy.utils.python import flatten, to_unicode
...
def load_object(path):
    ...
    instance, e.g. 'jscrapy.downloadermiddlewares.redirect.RedirectMiddleware'.
...
def walk_modules(path):
    ...
    For example: walk_modules('jscrapy.utils')
    """
...
def extract_regex(regex, text, encoding='utf-8'):
    ...
    * if the regex doesn't contain any group the entire regex matching is returned
    """
    warnings.warn(
        "jscrapy.utils.misc.extract_regex has moved to parsel.utils.extract_regex.",
...
def warn_on_generator_with_return_value(spider, callable):
    ...
    try:
        ...
        warnings.warn(
            ...
            'Scrapy issue tracker (https://github.com/jscrapy/jscrapy/issues), '
