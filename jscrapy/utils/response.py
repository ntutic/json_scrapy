...
from jscrapy.utils.decorators import deprecated
...
def get_base_url(response: "jscrapy.http.response.text.TextResponse") -> str:
...
def get_meta_refresh(
    response: "jscrapy.http.response.text.TextResponse",
...
def open_in_browser(
    response: Union["jscrapy.http.response.html.HtmlResponse", "jscrapy.http.response.text.TextResponse"],
    _openfunc: Callable[[str], Any] = webbrowser.open,
) -> Any:
    """Open the given response in a local web browser, populating the <base>
    tag for external links to work
    """
    from jscrapy.http import HtmlResponse, TextResponse
