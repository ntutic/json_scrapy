...
class Selector(_ParselSelector, object_ref):
    ...
    ``response`` is an :class:`~jscrapy.http.HtmlResponse` or an
    :class:`~jscrapy.http.XmlResponse` object that will be used for selecting
    and extracting data.
    ...
    * ``"html"`` for :class:`~jscrapy.http.HtmlResponse` type
    * ``"xml"`` for :class:`~jscrapy.http.XmlResponse` type
