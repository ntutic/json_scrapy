...
from jscrapy.core.downloader.handlers.http11 import TunnelError
from jscrapy.exceptions import NotConfigured
from jscrapy.http.request import Request
from jscrapy.spiders import Spider
from jscrapy.utils.python import global_object_name
from jscrapy.utils.response import response_status_message
...
def get_retry_request(
    ...
    *,
    ...
    """
    Returns a new :class:`~jscrapy.Request` object to retry the specified
    request, or ``None`` if retries of the specified request have been
    exhausted.

    For example, in a :class:`~jscrapy.Spider` callback, you could use it as
    follows::
    ...
    *spider* is the :class:`~jscrapy.Spider` instance which is asking for the
