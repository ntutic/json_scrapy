...
from jscrapy.extensions.postprocessing import PostProcessingManager
from jscrapy.utils.boto import is_botocore_available
from jscrapy.utils.conf import feed_complete_default_values_from_settings
from jscrapy.utils.ftp import ftp_store_file
from jscrapy.utils.log import failure_to_exc_info
from jscrapy.utils.misc import create_instance, load_object
from jscrapy.utils.python import get_func_args, without_none_values
        ...
        for uri_template, values in self.feeds.items():
            if values['batch_item_count'] and not re.search(r'%\(batch_time\)s|%\(batch_id\)', uri_template):
                logger.error(
                    ...
                    'https://docs.jscrapy.org/en/latest/topics/feed-exports.html#feed-export-batch-item-count',
                    uri_template
                )
                return False
        return True
