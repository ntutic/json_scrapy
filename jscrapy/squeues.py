...
from jscrapy.utils.deprecate import create_deprecated_class
from jscrapy.utils.request import request_from_dict
...
def _jscrapy_serialization_queue(queue_class):
...
def _jscrapy_non_serialization_queue(queue_class):
...
PickleFifoDiskQueue = _jscrapy_serialization_queue(_PickleFifoSerializationDiskQueue)
PickleLifoDiskQueue = _jscrapy_serialization_queue(_PickleLifoSerializationDiskQueue)
MarshalFifoDiskQueue = _jscrapy_serialization_queue(_MarshalFifoSerializationDiskQueue)
MarshalLifoDiskQueue = _jscrapy_serialization_queue(_MarshalLifoSerializationDiskQueue)
FifoMemoryQueue = _jscrapy_non_serialization_queue(queue.FifoMemoryQueue)
LifoMemoryQueue = _jscrapy_non_serialization_queue(queue.LifoMemoryQueue)
