...
from jscrapy.http import Response, XmlResponse
from jscrapy.downloadermiddlewares.decompression import DecompressionMiddleware
from jscrapy.spiders import Spider
from tests import get_testdata
from jscrapy.utils.test import assert_samelines
